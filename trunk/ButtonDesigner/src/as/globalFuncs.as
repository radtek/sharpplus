...
public function setFilter(whichItem:String, filters:Array){
	this['my'+whichItem].filters=filters;
}
...
public function setPropertyStringValue(whichProperty:String, whatValue:String, whichItem:String):void {
	this['my' + whichItem][whichProperty]=whatValue;	
}
