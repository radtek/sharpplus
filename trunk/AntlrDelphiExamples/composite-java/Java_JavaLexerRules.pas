...
type
    ...
    // delegators
    public 
          gJava:TAntlrBaseRecognizer{TJavaLexer};
      public  
            gParent:TAntlrBaseRecognizer{TJavaLexer};      
      constructor CreateWithStream(input:ICharStream;AState:TRecognizerSharedState; gJava:TAntlrBaseRecognizer{TJavaLexer} );
...
constructor TJava_JavaLexerRules.CreateWithStream(input:ICharStream;AState:TRecognizerSharedState; gJava:TAntlrBaseRecognizer{TJavaLexer} );
begin
...
destructor TJava_JavaLexerRules.Destroy;
begin
 inherited;
end;

function TJava_JavaLexerRules.GetGrammarFileName():String;
begin
  Result:='JavaLexerRules.g';
end;

// $ANTLR start "HexLiteral"
procedure TJava_JavaLexerRules.mHexLiteral();
var
...
procedure TJava_JavaLexerRules.mDecimalLiteral();
var
...
procedure TJava_JavaLexerRules.mOctalLiteral();
var
...
procedure TJava_JavaLexerRules.mHexDigit();
var
...
procedure TJava_JavaLexerRules.mIntegerTypeSuffix();
var
...
procedure TJava_JavaLexerRules.mFloatingPointLiteral();
var
...
begin
    try 
         ...
         *  The Java_JavaLexerRules attribute is inherited via the parser, lexer, ...
         *}
...
procedure TJava_JavaLexerRules.mExponent();
var
...
procedure TJava_JavaLexerRules.mFloatTypeSuffix();
var
...
procedure TJava_JavaLexerRules.mCharacterLiteral();
var
...
procedure TJava_JavaLexerRules.mStringLiteral();
var
...
procedure TJava_JavaLexerRules.mEscapeSequence();
var
...
procedure TJava_JavaLexerRules.mOctalEscape();
var
...
procedure TJava_JavaLexerRules.mUnicodeEscape();
var
...
procedure TJava_JavaLexerRules.mENUM();
var
...
procedure TJava_JavaLexerRules.mIdentifier();
var
...
procedure TJava_JavaLexerRules.mLetter();
var
...
procedure TJava_JavaLexerRules.mJavaIDDigit();
var
...
procedure TJava_JavaLexerRules.mWS();
var
...
procedure TJava_JavaLexerRules.mCOMMENT();
var
...
procedure TJava_JavaLexerRules.mLINE_COMMENT();
var
...
procedure TJava_JavaLexerRules.mTokens();
var
...
function TJava_JavaLexerRules.getDfa19:IDFA;
begin
...
constructor TJava_JavaLexerRules.TAntlrDFA19.Create(ARecognizer:TAntlrBaseRecognizer);
begin
  inherited Create;
...
function TJava_JavaLexerRules.TAntlrDFA19.getDescription():string;
begin
...
function TJava_JavaLexerRules.getDfa30:IDFA;
begin
...
constructor TJava_JavaLexerRules.TAntlrDFA30.Create(ARecognizer:TAntlrBaseRecognizer);
begin
  inherited Create;
  recognizer:=ARecognizer;
  decisionNumber:=30;
...
function TJava_JavaLexerRules.TAntlrDFA30.getDescription():string;
begin
