...
type
    TSimple_CommonLexer = class(TAntlrLexer)
    public
      const WS=12;
      const T__16=16;
      const T__15=15;
    ...
    // delegators
    public 
          gSimple:TAntlrBaseRecognizer{TSimpleLexer};
      public  
            gParent:TAntlrBaseRecognizer{TSimpleLexer};      
      constructor CreateWithStream(input:ICharStream;AState:TRecognizerSharedState; gSimple:TAntlrBaseRecognizer{TSimpleLexer} );
...
constructor TSimple_CommonLexer.CreateWithStream(input:ICharStream;AState:TRecognizerSharedState; gSimple:TAntlrBaseRecognizer{TSimpleLexer} );
begin
  Inherited CreateWithStream(input, AState);
  //InitMembers
  
         
self.gSimple := gSimple;
gParent := gSimple;
end;

destructor TSimple_CommonLexer.Destroy;
begin
 inherited;
end;

function TSimple_CommonLexer.GetGrammarFileName():String;
begin
  Result:='CommonLexer.g';
end;

// $ANTLR start "ID"
procedure TSimple_CommonLexer.mID();
var
...
procedure TSimple_CommonLexer.mINT();
var
...
procedure TSimple_CommonLexer.mFLOAT();
var
...
procedure TSimple_CommonLexer.mCHAR();
var
...
procedure TSimple_CommonLexer.mT_STRING();
var
...
procedure TSimple_CommonLexer.mESC();
var
...
procedure TSimple_CommonLexer.mCOMMENT();
var
...
procedure TSimple_CommonLexer.mLINE_COMMENT();
var
...
procedure TSimple_CommonLexer.mWS();
var
...
procedure TSimple_CommonLexer.mTokens();
var
...
begin
    try 
         ...
         *  The Simple_CommonLexer attribute is inherited via the parser, lexer, ...
         *}
...
function TSimple_CommonLexer.getDfa11:IDFA;
begin
...
constructor TSimple_CommonLexer.TAntlrDFA11.Create(ARecognizer:TAntlrBaseRecognizer);
begin
  inherited Create;
...
function TSimple_CommonLexer.TAntlrDFA11.getDescription():string;
begin
