...
CFLAGS= -fno-common -I/local/include  -std=c99 -fno-common -fomit-frame-pointer -IC:/msys/1.0/local/include/schroedinger-1.0 -IC:/msys/1.0/local/include/liboil-0.3 -g -Wdeclaration-after-statement -Wall -Wno-switch -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wcast-qual -Wwrite-strings -Wundef -O3 -fno-math-errno -fno-tree-vectorize -Werror=implicit
ASFLAGS= -fno-common -I/local/include  -g
CC_O=-o $@
LDFLAGS=  -L/local/lib -Wl,--warn-common -Wl,--as-needed -Wl,-rpath-link,$(BUILD_ROOT)/libpostproc -Wl,-rpath-link,$(BUILD_ROOT)/libswscale -Wl,-rpath-link,$(BUILD_ROOT)/libavfilter -Wl,-rpath-link,$(BUILD_ROOT)/libavdevice -Wl,-rpath-link,$(BUILD_ROOT)/libavformat -Wl,-rpath-link,$(BUILD_ROOT)/libavcodec -Wl,-rpath-link,$(BUILD_ROOT)/libavutil -Wl,-Bsymbolic
...
EXTRALIBS=  -lpsapi -lz -lbz2 -lpthreadGC2 -lm -lavifil32 -lfaac -lfaad -lgsm -lmp3lame -lm -lnut -lopencore-amrnb -lm -lopencore-amrwb -lm -lopenjpeg -LC:/msys/1.0/local/lib -lrtmp -lz -lssl -lcrypto -lws2_32 -lgdi32 -lcrypt32 -lwinmm -LC:/msys/1.0/local/lib -lschroedinger-1.0 -loil-0.3 -lm -lspeex -ltheoraenc -ltheoradec -logg -lvorbisenc -lvorbis -logg -lvpx -lvpx -LC:/msys/1.0/local/lib -lx264 -lpthreadGC2 -lxvidcore -lws2_32 -lgdi32 -lavicap32
INSTALL=install
LIBTARGET=i386
