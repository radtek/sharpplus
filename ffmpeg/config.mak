...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--enable-shared --disable-static --enable-libvpx --enable-librtmp --enable-memalign-hack --target-os=mingw32 --enable-avisynth --enable-libopenjpeg --enable-gpl --enable-version3 --enable-zlib --enable-bzlib --enable-libgsm --enable-libfaac --enable-pthreads --enable-libvorbis --enable-nonfree --enable-libtheora --enable-libspeex --enable-libmp3lame --enable-libxvid --enable-libschroedinger --enable-libx264 --enable-libnut --enable-libopencore-amrnb --enable-libopencore-amrwb --enable-avfilter --enable-runtime-cpudetect --extra-cflags=-fno-common --extra-cflags=-I/local/include --extra-ldflags=-L/local/lib
prefix=/usr/local
...
SRC_PATH="/home/hubdog/ffmpeg"
SRC_PATH_BARE=/home/hubdog/ffmpeg
BUILD_ROOT="/home/hubdog/ffmpeg"
CC_IDENT=gcc 4.2.1-sjlj (mingw32-2)
ARCH=x86
CC=gcc
AS=gcc
LD=gcc
...
CFLAGS= -fno-common -I/local/include  -std=c99 -fno-common -fomit-frame-pointer -IC:/msys/1.0/local/include/schroedinger-1.0 -IC:/msys/1.0/local/include/liboil-0.3 -g -Wdeclaration-after-statement -Wall -Wno-parentheses -Wno-switch -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wcast-qual -Wwrite-strings -Wundef -O3 -fno-math-errno -fno-tree-vectorize -Werror=implicit-function-declaration
ASFLAGS= -fno-common -I/local/include  -g
CC_O=-o $@
LDFLAGS= -L/local/lib -Wl,--warn-common -Wl,--as-needed -Wl,-rpath-link,$(BUILD_ROOT)/libpostproc -Wl,-rpath-link,$(BUILD_ROOT)/libswscale -Wl,-rpath-link,$(BUILD_ROOT)/libavfilter -Wl,-rpath-link,$(BUILD_ROOT)/libavdevice -Wl,-rpath-link,$(BUILD_ROOT)/libavformat -Wl,-rpath-link,$(BUILD_ROOT)/libavcodec -Wl,-rpath-link,$(BUILD_ROOT)/libavcore -Wl,-rpath-link,$(BUILD_ROOT)/libavutil -Wl,-Bsymbolic
FFSERVERLDFLAGS=-Wl,-E
SHFLAGS=-shared -Wl,--output-def,$$(@:$(SLIBSUF)=.def) -Wl,--enable-runtime-pseudo-reloc -Wl,--enable-auto-image-base -Wl,--version-script,$(SUBDIR)lib$(NAME).ver
...
EXTRALIBS=-lavicap32 -lgdi32 -lws2_32 -lxvidcore -LC:/msys/1.0/local/lib -lx264 -lpthreadGC2 -lvpx -lvpx -lvorbisenc -lvorbis -logg -ltheoraenc -ltheoradec -logg -lspeex -LC:/msys/1.0/local/lib -lschroedinger-1.0 -loil-0.3 -lm -LC:/msys/1.0/local/lib -lrtmp -lz -lssl -lcrypto -lws2_32 -lgdi32 -lcrypt32 -lwinmm -lopenjpeg -lopencore-amrwb -lopencore-amrnb -lnut -lmp3lame -lgsm -lfaac -lavifil32 -lm -lpthreadGC2 -lbz2 -lz -lpsapi 
INSTALL=install
LIBTARGET=i386
...
libavcodec_VERSION=52.85.0
libavcodec_VERSION_MAJOR=52
libavcore_VERSION=0.3.0
libavcore_VERSION_MAJOR=0
libavdevice_VERSION=52.2.1
libavdevice_VERSION_MAJOR=52
libavformat_VERSION=52.78.1
libavformat_VERSION_MAJOR=52
libavutil_VERSION=50.23.0
libavutil_VERSION_MAJOR=50
libavfilter_VERSION=1.34.0
...
VCODEC_TESTS=asv1 asv2 dnxhd_1080i dnxhd_720p dnxhd_720p_rd dv dv50 error ffv1 flashsv flv h261 h263 h263p huffyuv jpegls ljpeg mjpeg mpeg mpeg1b mpeg2 mpeg2thread mpeg4 mpeg4adv mpeg4nr mpeg4thread msmpeg4 msmpeg4v2 rc rgb roq rv10 rv20 snow snowll svq1 wmv1 wmv2 yuv 
LAVF_TESTS=aiff alaw asf au avi bmp dv_fmt ffm flv_fmt gif gxf jpg mkv mmf mov mpg mulaw mxf nut ogg pbmpipe pcx pgm pgmpipe pixfmt ppm ppmpipe rm sgi swf tga tiff ts voc wav yuv4mpeg 
LAVFI_TESTS=crop crop_scale crop_scale_vflip crop_vflip null pixdesc_le pixfmts_crop_le pixfmts_null_le pixfmts_pad_le pixfmts_scale_le pixfmts_vflip_le scale200 scale500 vflip vflip_crop vflip_vflip 
